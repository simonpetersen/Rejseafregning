...
public class CirkulationCellTable extends Composite {
	...
	interface MyEventBinder extends EventBinder<CirkulationCellTable> {
	}
	...
	public CirkulationCellTable(EventBus eventBus, List<RejseafregningDTO> dokumenter) {
