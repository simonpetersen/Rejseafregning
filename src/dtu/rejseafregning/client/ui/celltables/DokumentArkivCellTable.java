...
public class DokumentArkivCellTable extends Composite {
	...
	private static final ProvidesKey<RejseafregningDTO> KEY_PROVIDER=new ProvidesKey<RejseafregningDTO>(){@Override public Object getKey(RejseafregningDTO item){return item.getRejseafregningID();}};

	public DokumentArkivCellTable(EventBus eventBus, List<RejseafregningDTO> dokumenter) {
			...
			Column<RejseafregningDTO, String> navnColumn = new Column<RejseafregningDTO, String>(navnCell){
				@Override
				public String getValue(RejseafregningDTO object){
					return object.getMedarbejderNavn();
				}
			};
			cellTable.addColumn(navnColumn, "Navn");
